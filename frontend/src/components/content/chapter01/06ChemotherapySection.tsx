// src/components/content/chapter01/ChemotherapySection.tsx
...
export const ChemotherapySection: React.FC = () => (
  <>
    ...
    >
      <div className="space-y-4">
        <p className="text-slate-700 leading-relaxed">
          Chemotherapy is a general term to indicate the use of chemicals as a therapy. However, the term is 
          commonly used for cytotoxic chemotherapy in cancer management and is considered as hazardous drugs. 
          Systemic Anti-Cancer Therapy (SACT) refers to drug-based cancer treatments introduced as systemic 
          therapy and it includes chemotherapy, hormone drugs, immunotherapy, targeted therapy, and antibody-drug 
          conjugates.
        </p>
        
        <div className="bg-teal-50 rounded-lg p-4 border-2 border-teal-200">
          <p className="text-slate-700 text-sm">
            <strong>SACT Applications:</strong> Can be used either alone or in combination with other types of 
            treatments such as surgery or radiation therapy. Combination treatments are effective and common in 
            the eradication or mitigation of cancer.
          </p>
        </div>

        <p className="text-slate-700 leading-relaxed">
          Chemotherapy is administered through oral, intravenous (IV), subcutaneous (SC), intramuscular (IM), 
          or intrathecal routes (IT). IV route administration is common due to increased bioavailability, 
          versatility, and flexibility in treatment dosages when compared to other routes of administration.
        </p>
      </div>
    </ContentCard>
    ...
    >
      <div className="space-y-4">
        <p className="text-slate-700 leading-relaxed">
          Chemotherapeutic agents were developed in the 1940s and were primarily used to treat cancer and a few 
          other non-oncology indications such as arthritis, and lupus. Chemotherapy shows cytotoxic properties 
          (kills cancer cells) in providing therapeutic efficacy.
        </p>

        <p>Non-selective mechanisms and narrow therapeutic properties of many agents cause numerous adverse effects. Therefore, target-specific drugs which mainly target cancer cells or specific proteins on cancer cells are introduced. However, those agents are not cost-effective with advanced processing mechanisms.</p> 
        ...
        <InfoBox type="note">
          Adverse effects of chemotherapy are mainly classified according to: <strong>(1)</strong> general 
          mechanisms of drugs (non-selective vs target-specific), <strong>(2)</strong> drug groups, 
          <strong>(3)</strong> body systems or organs (cardiac, hepatic, renal, hematopoietic, pulmonary, 
          reproductive, dermal etc.), and <strong>(4)</strong> adverse effects presenting time (acute vs chronic).
        </InfoBox>
      </div>
    </ContentCard>
    ...
    {/* Classification Table 2: Drug Groups */}
    <ContentCard 
    ...
    >
      <p className="text-slate-700 leading-relaxed mb-6">
        Adverse effects of chemotherapy can be outlined according to the presenting time. Generally, reversible 
        adverse effects are present after administration of chemotherapy and are considered as acute adverse 
        effects. Late effects are regarded as long-term and non-reversible.
      </p>
      ...
      <div className="grid md:grid-cols-2 gap-4 mt-6">
        <div className="bg-orange-50 rounded-lg p-5 border-2 border-orange-200">
          ...
          <p className="text-sm text-slate-700">
            Occur shortly after treatment administration. Generally reversible with proper management and 
            supportive care.
          </p>
        </div>
        ...
        <div className="bg-red-50 rounded-lg p-5 border-2 border-red-200">
          ...
          <p className="text-sm text-slate-700">
            Long-term or late-onset effects that may persist after treatment completion. Often non-reversible 
      ...
      <InfoBox type="tip">
        <strong>Clinical Practice Note:</strong> Understanding the temporal pattern of adverse effects is crucial 
        for oncology nurses to provide appropriate patient education, implement timely interventions, and plan 
