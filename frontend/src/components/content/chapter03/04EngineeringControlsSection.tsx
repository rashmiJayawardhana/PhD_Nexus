// FILE: src/components/content/chapter03/04EngineeringControlsSection.tsx
...
export const EngineeringControlsSection: React.FC = () => {
  const { data, source } = useHybridContent({
    ...
    fallbackData: ENGINEERING_FALLBACK
  });
    ...
    <>
      ...
      >
        <div className="space-y-4">
          ...
          <InfoBox type="note">
            <strong>When to Use:</strong> {data.cpecWhen}
          </InfoBox>
        </div>
      </ContentCard>
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white rounded-lg p-5 border-2 border-slate-200 shadow-inner">
            <p className="text-slate-700 leading-relaxed">
              {data.cpecUseRecommendation}
            </p>
          </div>

          {/* BSC Section */}
          <div className="bg-linear-to-br from-cyan-50 to-blue-50 rounded-xl p-6 border-2 border-cyan-200 shadow-lg">
              ...
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  ...
                  <ul className="space-y-2 text-sm text-slate-700">
                    {data.bscFeatures.map((feature: string, idx: number) => (
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-4">
              ...
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  ...
                  <ul className="space-y-2 text-sm text-slate-700">
                    {data.caciFeatures.map((feature: string, idx: number) => (
                      <li key={idx} className="flex items-start gap-2">
          ...
          <InfoBox type="tip">
            <strong>Essential Practice:</strong> {data.cpecEssentialPractice}
          </InfoBox>
        </div>
      </ContentCard>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-linear-to-br from-blue-50 to-cyan-50 rounded-xl p-6 border-2 border-blue-300 shadow-md">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-3">
                {data.csecRequirements.slice(0, 3).map((req: string, idx: number) => {
                  const icons = ['💨', '🌬️', '🔬'];
                  return (
                    <div key={idx} className="bg-white rounded-lg p-3 shadow-sm">
                      <div className="flex items-start gap-2">
                        <span className="text-blue-600 font-bold text-lg">{icons[idx]}</span>
              ...
              <div className="space-y-3">
                {data.csecRequirements.slice(3).map((req: string, idx: number) => {
                  const icons = ['🌡️', '💧', '🚪'];
                  return (
                    <div key={idx} className="bg-white rounded-lg p-3 shadow-sm">
                      <div className="flex items-start gap-2">
      ...
      >
        <div className="space-y-5">
          <div className="bg-green-50 rounded-xl p-5 border-2 border-green-200">
            <p className="text-slate-700 leading-relaxed text-base">
              {data.supplementalIntro}
            </p>
          </div>

          <div className="bg-linear-to-br from-green-50 to-teal-50 rounded-xl p-6 border-2 border-green-200 shadow-lg">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-4">
              ...
              <div className="space-y-3">
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  ...
                  <ul className="space-y-2 text-sm text-slate-700">
                    {data.cstdTypesList.map((type: string, idx: number) => (
                      <li key={idx} className="flex items-start gap-2">
            ...
            <div className="bg-white rounded-lg p-5 shadow-sm border-l-4 border-green-500">
              ...
              <ul className="space-y-1 text-sm text-slate-700">
                {data.cstdBenefits.map((benefit: string, idx: number) => (
