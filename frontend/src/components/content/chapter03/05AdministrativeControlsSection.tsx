          ...
          <div className="space-y-3">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-indigo-500">
              <div className="flex items-start gap-3">
                <span className="bg-indigo-100 text-indigo-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">1</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-purple-500">
              <div className="flex items-start gap-3">
                <span className="bg-purple-100 text-purple-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">2</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-teal-500">
              <div className="flex items-start gap-3">
                <span className="bg-teal-100 text-teal-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">3</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-red-500">
              <div className="flex items-start gap-3">
                <span className="bg-red-100 text-red-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">5</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-orange-500">
              <div className="flex items-start gap-3">
                <span className="bg-orange-100 text-orange-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">6</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-green-500">
              <div className="flex items-start gap-3">
                <span className="bg-green-100 text-green-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">7</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-yellow-500">
              <div className="flex items-start gap-3">
                <span className="bg-yellow-100 text-yellow-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">8</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-pink-500">
              <div className="flex items-start gap-3">
                <span className="bg-pink-100 text-pink-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">9</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-cyan-500">
              <div className="flex items-start gap-3">
                <span className="bg-cyan-100 text-cyan-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">10</span>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-violet-500">
              <div className="flex items-start gap-3">
                <span className="bg-violet-100 text-violet-700 font-bold rounded-full w-7 h-7 flex items-center justify-center text-sm shrink-0">11</span>
