// FILE: src/components/content/chapter04/02ReceivingStorageSection.tsx
...
export const ReceivingStorageSection = () => {
  const { data, source } = useHybridContent({
    ...
    sectionId: 'receiving',
    fallbackData: RECEIVING_FALLBACK
  });
    ...
    <>
      ...
      >
        <div className="space-y-5">
          ...
          {/* Visual Process Flow - NOT editable (icons/layout) */}
          ...
          {/* Key Requirements Summary - NOT editable (visual layout) */}
          ...
          <InfoBox type="warning">
            <strong>Important:</strong> {data.warningNote}
          </InfoBox>
        </div>
      </ContentCard>
    </>
