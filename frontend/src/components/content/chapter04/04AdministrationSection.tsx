// FILE: src/components/content/chapter04/04AdministrationSection.tsx (Updated)
...
export const AdministrationSection = () => {
  const { data, source } = useHybridContent({
    ...
    fallbackData: ADMINISTRATION_FALLBACK
  });
    ...
    <>
      ...
      >
        <div className="space-y-5">
          ...
          <InfoBox type="critical">
            <strong>Exposure Risk:</strong> {data.exposureRisk}
          </InfoBox>
          ...
          <div className="bg-linear-to-br from-purple-50 to-indigo-50 rounded-xl p-6 border-2 border-purple-300 shadow-lg mt-6">
            ...
            <ProcedureList
              items={data.parenteralPrecautions}
              variant="purple"
            />
          ...
          <InfoBox type="warning">
            <strong>Critical Practice:</strong> {data.criticalPractice}
          </InfoBox>
        </div>
      </ContentCard>
      ...
      <ContentCard title="Oral Administration" icon={<span className="text-2xl">💊</span>} variant="info">
        <div className="space-y-5">
          ...
          <InfoBox type="tip">
            <strong>Patient Education:</strong> {data.patientEducation}
          </InfoBox>
        </div>
      </ContentCard>
