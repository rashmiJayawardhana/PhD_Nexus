    ...
    subTopics: [
      {
        ...
        content: `
          <h2>Overview of Cancer</h2>
          <p>Cancer is the generic name for neoplasms/tumors. Tumors are of two types, benign and cancerous.</p>
          <ul>
            <li><strong>Benign tumors:</strong> Grow slowly and usually do not invade other tissues or convert to cancer</li>
            <li><strong>Malignant tumors:</strong> Demonstrate uncontrolled cell division and the potential to invade surrounding tissues</li>
          </ul>
          <h3>Types of Cancer</h3>
          <p><strong>Solid Cancers:</strong> Abnormal cells create a mass or lump (e.g., breast and prostate cancers)</p>
          <p><strong>Liquid Cancers:</strong> Abnormal cell buildup in blood, bone marrow, and lymphatic system (e.g., leukemia, myeloma)</p>
        `
      },
      {
        ...
        content: `
          ...
          <p>Cancer is a global health concern causing one in six deaths (16.8%) globally.</p>
          <h3>Global Statistics (2022)</h3>
          <ul>
            <li>20 million new cases</li>
            <li>9.7 million deaths</li>
            <li>Predicted 77% increase by 2050</li>
          </ul>
          <h3>Most Common Cancers Globally</h3>
          <ol>
            <li>Lung cancer (2.5 million, 12.4%)</li>
            <li>Breast cancer (2.3 million, 11.6%)</li>
            <li>Colorectal cancer (1.9 million, 9.6%)</li>
            <li>Prostate cancer (1.5 million, 7.3%)</li>
            <li>Stomach cancer (970,000, 4.9%)</li>
          </ol>
        `
      },
      {
        ...
        content: `
          ...
          <table>
            ...
            <tr>
              <td>Surgery</td>
              <td>Surgical removal of cancer or affected body parts</td>
            </tr>
            <tr>
              <td>Radiotherapy</td>
              <td>Use of controlled radiation doses to destroy cancer cells</td>
            </tr>
            <tr>
              <td>Chemotherapy</td>
              <td>Drugs that kill cancer cells or slow their growth</td>
            </tr>
            <tr>
              <td>Hormone Therapy</td>
              <td>Replace natural hormones in hormone-sensitive cancers</td>
            </tr>
            <tr>
              <td>Immunotherapy</td>
              <td>Harness the immune system to act against cancer</td>
            </tr>
            <tr>
              <td>Targeted Therapy</td>
              <td>Target specific features of cancer cells</td>
            </tr>
          </table>
        `
      },
      {
        ...
        content: `
          ...
          <p>Anti-cancer chemotherapy and other drugs are considered hazardous due to:</p>
          <ul>
            ...
            <li>Genotoxicity</li>
            <li>Structure and toxicity profiles mimicking existing hazardous drugs</li>
          </ul>
        `
      },
      {
        ...
        content: `
          ...
          <h3>Definition</h3>
          <p>Systemic Anti-Cancer Therapy (SACT) refers to drug-based cancer treatments including:</p>
          <ul>
            <li>Chemotherapy</li>
            <li>Hormone drugs</li>
            <li>Immunotherapy</li>
          ...
          <h4>Acute Effects (Immediate to days)</h4>
          <ul>
          ...
          <h4>Chronic Effects (Weeks to months)</h4>
          <ul>
            <li>Bone marrow suppression</li>
            <li>Organ toxicities</li>
            <li>Reproductive adverse effects</li>
